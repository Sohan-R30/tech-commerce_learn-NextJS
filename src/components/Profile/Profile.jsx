        ...
        <div className="my-10">
            ...
            <div className="flex flex-wrap items-end justify-start gap-10">
                ...
                <div className="max-w-sm border rounded-md p-5 my-5 shadow-sm">
                    ...
                    <button onClick={handleUpdateProfilePicture} className="buttonStyle  rounded-md  bg-primaryColor hover:bg-[#0065a3] w-2/4 hover:text-sm">Update</button>
                </div>
                <div className="max-w-sm border rounded-md p-5 my-5 shadow-sm">
                    ...
                    <button onClick={handleUpdateProfileName} className="buttonStyle  rounded-md  bg-primaryColor hover:bg-[#0065a3] w-2/4 hover:text-sm">Update</button>
                </div>
                <div className="max-w-sm border rounded-md p-5 my-5 shadow-sm">
                    ...
                    <p className="my-2 font-bold">{!users?.emailVerified && <span onClick={handleVerifyEmail} className="buttonStyle  rounded-md  bg-primaryColor hover:bg-[#0065a3] w-2/4 hover:text-sm">Verify</span>}</p>
                </div>
            </div>
        </div>
    );
